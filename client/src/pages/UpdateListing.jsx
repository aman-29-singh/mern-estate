...
export default function UpdateListing() {
  ...
  useEffect(()=> {
    const fetchListing = async () => {
        const listingId = params.listingId;//particular listingId jo humne app.jsx k route  mein pass kiya tha uska data fetch karliya
        console.log(listingId);//so we have a listingId now of that particular user
        /*based on this listingId we wanna fetch the information about this particular listing so we need to create 
        another api route for this listing i.e router..get('/get/:id', getListing)   */ 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`/api/listing/update/${params.listingId}`, {//this is for Edit the particular Listing page
        method: 'POST',
        headers: {
